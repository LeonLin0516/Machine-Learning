...
Regularized_1 = Theta1.^2;
Regularized_1(:,1) = 0;
Regularized_1 = sum(sum(Regularized_1));

Regularized_2 = Theta2.^2;
Regularized_2(:,1) = 0;
Regularized_2 = sum(sum(Regularized_2));

J = J + lambda / (2 * m) * (Regularized_1 + Regularized_2);
